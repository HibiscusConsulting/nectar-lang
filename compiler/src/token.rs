...
impl TokenKind {
    ...
    pub fn as_contextual_ident(&self) -> Option<&'static str> {
        match self {
            ...
            TokenKind::MustUse => Some("must_use"),
            ...
            TokenKind::A11y => Some("a11y"),
            TokenKind::Manual => Some("manual"),
            TokenKind::Hybrid => Some("hybrid"),
            TokenKind::Outlet => Some("outlet"),
            ...
            TokenKind::OnConnect => Some("on_connect"),
            TokenKind::OnDisconnect => Some("on_disconnect"),
            TokenKind::Prompt => Some("prompt"),
            TokenKind::Tool => Some("tool"),
            TokenKind::Transition => Some("transition"),
            TokenKind::Animate => Some("animate"),
            TokenKind::Manifest => Some("manifest"),
            TokenKind::Offline => Some("offline"),
            TokenKind::Gesture => Some("gesture"),
            TokenKind::Permissions => Some("permissions"),
            TokenKind::Meta => Some("meta"),
            TokenKind::Sitemap => Some("sitemap"),
    ...
    pub fn as_css_text(&self) -> String {
        match self {
            ...
            TokenKind::Render => "render".into(),
            TokenKind::Store => "store".into(),
            TokenKind::Signal => "signal".into(),
            TokenKind::Action => "action".into(),
            TokenKind::Computed => "computed".into(),
            TokenKind::Effect => "effect".into(),
            TokenKind::Selector => "selector".into(),
            TokenKind::Router => "router".into(),
            TokenKind::Route => "route".into(),
            TokenKind::Page => "page".into(),
            TokenKind::Form => "form".into(),
            TokenKind::Channel => "channel".into(),
            TokenKind::Agent => "agent".into(),
            TokenKind::App => "app".into(),
            TokenKind::Theme => "theme".into(),
            TokenKind::Auth => "auth".into(),
            TokenKind::Payment => "payment".into(),
            TokenKind::Upload => "upload".into(),
            TokenKind::Embed => "embed".into(),
            TokenKind::Pdf => "pdf".into(),
            TokenKind::Db => "db".into(),
            TokenKind::Cache => "cache".into(),
            TokenKind::Contract => "contract".into(),
            TokenKind::Async => "async".into(),
            TokenKind::Await => "await".into(),
            TokenKind::Lazy => "lazy".into(),
            TokenKind::Spring => "spring".into(),
            TokenKind::Keyframes => "keyframes".into(),
            TokenKind::Stagger => "stagger".into(),
            TokenKind::Shortcut => "shortcut".into(),
            TokenKind::Secret => "secret".into(),
            TokenKind::Atomic => "atomic".into(),
            TokenKind::Select => "select".into(),
            TokenKind::Test => "test".into(),
            TokenKind::Match => "match".into(),
            TokenKind::Fallback => "fallback".into(),
            TokenKind::Navigate => "navigate".into(),
            TokenKind::Guard => "guard".into(),
            TokenKind::Layout => "layout".into(),
            TokenKind::Breakpoint => "breakpoint".into(),
            TokenKind::Where => "where".into(),
            TokenKind::As => "as".into(),
            TokenKind::SelfKw => "self".into(),
            TokenKind::Spawn => "spawn".into(),
            TokenKind::Suspend => "suspend".into(),
            TokenKind::MustUse => "must_use".into(),
            TokenKind::Yield => "yield".into(),
            TokenKind::Try => "try".into(),
            TokenKind::Catch => "catch".into(),
            TokenKind::Banking => "banking".into(),
            TokenKind::MapKeyword => "map".into(),
            TokenKind::A11y => "a11y".into(),
            TokenKind::Manual => "manual".into(),
            TokenKind::Hybrid => "hybrid".into(),
            TokenKind::Outlet => "outlet".into(),
            TokenKind::Crypto => "crypto".into(),
            TokenKind::Virtual => "virtual".into(),
