...
impl StdLib {
    ...
    fn register_vec(&mut self) {
        ...
        let methods = vec![
            ...
            BuiltinFn {
                ...
                self_mutable: false,
                description:
                    "Return a new Vec containing only elements where `predicate` returns true."
                        .into(),
            },
            BuiltinFn {
                name: "is_empty".into(),
    ...
    fn register_hashmap(&mut self) {
        ...
        let methods = vec![
            BuiltinFn {
                ...
                self_mutable: true,
                description:
                    "Insert a key-value pair. Returns the previous value if the key existed.".into(),
            },
            BuiltinFn {
                name: "get".into(),
                params: vec![BuiltinParam {
                ...
                return_type: Type::Option(Box::new(Type::Reference {
                    mutable: false,
                    lifetime: None,
    ...
    fn register_option(&mut self) {
        ...
        let methods = vec![
            ...
            BuiltinFn {
                ...
                takes_self: true,
                self_mutable: false,
                description: "Apply `f` to the contained value if Some, returning Option<U>."
                    .into(),
            },
        ];
    ...
    fn register_string(&mut self) {
        ...
        let methods = vec![
            ...
            BuiltinFn {
                ...
                takes_self: true,
                self_mutable: false,
                description: "Return a new string with leading and trailing whitespace removed."
                    .into(),
            },
            BuiltinFn {
                name: "split".into(),
            ...
            BuiltinFn {
                ...
                takes_self: true,
                self_mutable: false,
                description: "Return a new string with all characters converted to uppercase."
                    .into(),
            },
            BuiltinFn {
                ...
                takes_self: true,
                self_mutable: false,
                description: "Return a new string with all characters converted to lowercase."
                    .into(),
            },
            BuiltinFn {
                name: "push_str".into(),
            ...
            BuiltinFn {
                ...
                takes_self: true,
                self_mutable: false,
                description: "Return a new string that is the concatenation of self and other."
                    .into(),
            },
            BuiltinFn {
                name: "substring".into(),
                ...
                takes_self: true,
                self_mutable: false,
                description: "Return the substring from byte index `start` to `end` (exclusive)."
                    .into(),
            },
            BuiltinFn {
                name: "index_of".into(),
                ...
                takes_self: true,
                self_mutable: false,
                description: "Return the byte index of the first occurrence of `pattern`, or None."
                    .into(),
            },
        ];
    ...
    fn register_iterator_trait(&mut self) {
        ...
        let methods = vec![
            ...
            BuiltinFn {
                ...
                self_mutable: false,
                description:
                    "Return an iterator that yields only elements where `predicate` is true.".into(),
            },
            BuiltinFn {
                name: "fold".into(),
                params: vec![
        ...
        self.register_type(BuiltinType {
            name: "Iterator".into(),
            type_params: vec!["T".into()],
            description: "The Iterator trait — lazy sequences with chainable transformations."
                .into(),
            methods,
            variants: vec![],
        });
        ...
        let fmt_fns = vec![
            BuiltinFn {
                ...
                params: vec![
                    ...
                    BuiltinParam {
                        name: "args".into(),
                        ty: Type::Array(Box::new(Type::Named("Any".into()))),
                    },
                ],
                return_type: string_ty.clone(),
                takes_self: false,
                self_mutable: false,
                description:
                    "Interpolate `args` into `template` placeholders and return a new String."
                        .into(),
            },
            BuiltinFn {
                name: "to_string".into(),
    ...
    fn register_collections_functions(&mut self) {
        ...
        let fns = vec![
            ...
            BuiltinFn {
                ...
                params: vec![BuiltinParam {
                    name: "items".into(),
                    ty: Type::Array(Box::new(any_array.clone())),
                }],
                return_type: any_array.clone(),
                takes_self: false,
                self_mutable: false,
    ...
    fn register_mask_functions(&mut self) {
        ...
        let fns = vec![
            ...
            BuiltinFn {
                ...
                self_mutable: false,
                description:
                    "Apply custom mask pattern (# = digit, A = letter, * = any). Pure WASM.".into(),
            },
        ];
        for f in fns {
            self.register_fn(f);
    ...
    fn register_search_functions(&mut self) {
        ...
        let fns = vec![
            BuiltinFn {
                ...
                self_mutable: false,
                description:
                    "Create a fuzzy search index over items using specified keys. Pure WASM.".into(),
            },
            BuiltinFn {
                ...
                params: vec![
                    BuiltinParam {
                        name: "index".into(),
                        ty: Type::Named("SearchIndex".into()),
                    },
                    BuiltinParam {
                        name: "query".into(),
                        ty: string_ty.clone(),
    ...
    fn register_theme_functions(&mut self) {
        ...
        let fns = vec![
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Initialize the theme system with a configuration. JS runtime bridge."
                    .into(),
            },
            BuiltinFn {
            ...
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Get the name of the currently active theme. JS runtime bridge."
                    .into(),
            },
        ];
        for f in fns {
    ...
    fn register_auth_functions(&mut self) {
        ...
        let fns = vec![
            BuiltinFn {
                ...
                self_mutable: false,
                description:
                    "Initialize the auth system with provider configuration. JS runtime bridge."
                        .into(),
            },
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Authenticate a user with username and password. JS runtime bridge."
                    .into(),
            },
            BuiltinFn {
            ...
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Get the currently authenticated user object. JS runtime bridge."
                    .into(),
            },
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Check whether a user is currently authenticated. JS runtime bridge."
                    .into(),
            },
        ];
        for f in fns {
    ...
    fn register_upload_functions(&mut self) {
        ...
        let fns = vec![
            BuiltinFn {
                ...
                self_mutable: false,
                description:
                    "Initialize the upload system with endpoint configuration. JS runtime bridge."
                        .into(),
            },
            BuiltinFn {
    ...
    fn register_db_functions(&mut self) {
        ...
        let fns = vec![
            ...
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Query the database with a filter expression. JS runtime bridge."
                    .into(),
            },
        ];
        for f in fns {
    ...
    fn register_responsive_functions(&mut self) {
        ...
        let fns = vec![
            BuiltinFn {
                ...
                params: vec![BuiltinParam {
                    name: "breakpoints".into(),
                    ty: any_ty.clone(),
                }],
                return_type: unit_ty.clone(),
                takes_self: false,
                self_mutable: false,
                description: "Register named breakpoints for responsive design. JS runtime bridge."
                    .into(),
            },
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Get the name of the currently active breakpoint. JS runtime bridge."
                    .into(),
            },
            BuiltinFn {
                ...
                self_mutable: false,
                description:
                    "Generate a fluid CSS value that scales between min and max. JS runtime bridge."
                        .into(),
            },
        ];
        for f in fns {
    ...
    fn register_data_table_type(&mut self) {
        ...
        self.register_type(BuiltinType {
            name: "DataTable".into(),
            type_params: vec!["T".into()],
            description: "A sortable, filterable, paginated data table. Pure WASM computation."
                .into(),
            methods: vec![
                BuiltinFn {
                    name: "sort".into(),
                ...
                BuiltinFn {
                    ...
                    self_mutable: true,
                    description:
                        "Pin a column so it stays visible during horizontal scroll. Pure WASM."
                            .into(),
                },
                BuiltinFn {
                    name: "edit_cell".into(),
                ...
                BuiltinFn {
                    ...
                    self_mutable: false,
                    description:
                        "Get the currently visible (filtered, sorted, paginated) rows. Pure WASM."
                            .into(),
                },
                BuiltinFn {
        ...
        let fns = vec![BuiltinFn {
            ...
            params: vec![
                ...
                BuiltinParam {
                    name: "columns".into(),
                    ty: Type::Array(Box::new(Type::Named("Column".into()))),
                },
            ],
            return_type: Type::Named("DataTable".into()),
            takes_self: false,
            self_mutable: false,
            description: "Create a new DataTable with data and column definitions. Pure WASM."
                .into(),
        }];
        for f in fns {
            self.register_fn(f);
    ...
    fn register_datepicker_functions(&mut self) {
        ...
        let fns = vec![
            BuiltinFn {
                ...
                params: vec![BuiltinParam {
                    name: "options".into(),
                    ty: Type::Named("DatePickerOptions".into()),
                }],
                return_type: i32_ty.clone(),
                takes_self: false,
                self_mutable: false,
                description:
                    "Create a date picker widget. Returns ID. Pure WASM — renders via DOM syscalls."
                        .into(),
            },
            BuiltinFn {
            ...
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Destroy a date picker widget and remove its DOM elements. Pure WASM."
                    .into(),
            },
        ];
        for f in fns {
    ...
    fn register_pagination_functions(&mut self) {
        ...
        let fns = vec![
            BuiltinFn {
                ...
                self_mutable: false,
                description:
                    "Paginate an array of items. Returns a Page with items and metadata. Pure WASM."
                        .into(),
            },
            BuiltinFn {
    ...
    fn register_combobox_functions(&mut self) {
        ...
        let fns = vec![
            BuiltinFn {
                ...
                self_mutable: false,
                description:
                    "Create a combobox widget. Returns ID. Pure WASM — renders via DOM syscalls."
                        .into(),
            },
            BuiltinFn {
            ...
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Apply a filter query to narrow the combobox options. Pure WASM."
                    .into(),
            },
            BuiltinFn {
    ...
    fn register_chart_functions(&mut self) {
        ...
        self.register_type(BuiltinType {
            name: "PieSlice".into(),
            type_params: vec![],
            description: "Data for a pie chart slice with label, value, and color. Pure WASM."
                .into(),
            methods: vec![],
            variants: vec![],
        });
        ...
        self.register_type(BuiltinType {
            ...
            type_params: vec![],
            description: "Options for chart rendering: width, height, title, animate. Pure WASM."
                .into(),
            methods: vec![],
            variants: vec![],
        });
    ...
    fn register_editor_functions(&mut self) {
        ...
        self.register_type(BuiltinType {
            ...
            type_params: vec![],
            description: "Options for creating a rich text editor: mode, placeholder. Pure WASM."
                .into(),
            methods: vec![],
            variants: vec![],
        });
    ...
    fn register_image_functions(&mut self) {
        ...
        let fns = vec![
            BuiltinFn {
                ...
                self_mutable: false,
                description:
                    "Crop an image to the specified rectangle. Pure WASM pixel manipulation.".into(),
            },
            BuiltinFn {
                ...
                self_mutable: false,
                description:
                    "Resize an image to the specified dimensions. Pure WASM pixel manipulation."
                        .into(),
            },
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Compress an image with the given quality (0.0 to 1.0). Pure WASM."
                    .into(),
            },
            BuiltinFn {
        ...
        let fns = vec![
            ...
            BuiltinFn {
                ...
                params: vec![
                    ...
                    BuiltinParam {
                        name: "columns".into(),
                        ty: Type::Array(Box::new(string_ty.clone())),
                    },
                ],
                return_type: string_ty.clone(),
                takes_self: false,
                self_mutable: false,
                description: "Export typed objects to CSV with specified columns. Pure WASM."
                    .into(),
            },
        ];
        for f in fns {
    ...
    fn register_maps_functions(&mut self) {
        ...
        self.register_type(BuiltinType {
            ...
            type_params: vec![],
            description:
                "Options for creating a map: center_lat, center_lng, zoom, tile_url. Pure WASM."
                    .into(),
            methods: vec![],
            variants: vec![],
        });
    ...
    fn register_share_functions(&mut self) {
        ...
        let fns = vec![
            BuiltinFn {
                ...
                self_mutable: false,
                description:
                    "Trigger native share dialog (navigator.share). WASM logic + one JS syscall."
                        .into(),
            },
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Check if native sharing is available. WASM logic + one JS syscall."
                    .into(),
            },
        ];
        for f in fns {
    ...
    fn register_rtc_functions(&mut self) {
        ...
        self.register_type(BuiltinType {
            ...
            type_params: vec![],
            description:
                "Configuration for an RTCPeerConnection. WASM builds config, JS creates the peer."
                    .into(),
            methods: vec![],
            variants: vec![],
        });
        ...
        self.register_type(BuiltinType {
            name: "RtcStats".into(),
            type_params: vec![],
            description: "WebRTC connection statistics. WASM parses the stats from the JS bridge."
                .into(),
            methods: vec![BuiltinFn {
                name: "get".into(),
                params: vec![BuiltinParam {
    ...
    fn register_miniprogram_functions(&mut self) {
        ...
        let fns = vec![
            ...
            BuiltinFn {
                ...
                self_mutable: false,
                description:
                    "Store a key-value pair in local storage. Aliases webapi localStorage.".into(),
            },
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Read a value from local storage by key. Aliases webapi localStorage."
                    .into(),
            },
            BuiltinFn {
            ...
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Navigate to a URL (push onto route stack). Aliases webapi pushState."
                    .into(),
            },
            BuiltinFn {
            ...
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Show an alert dialog with title and content. Callback on dismiss."
                    .into(),
            },
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Show a confirm dialog. Callback receives confirm/cancel result."
                    .into(),
            },
            // ── Device ──
            BuiltinFn {
            ...
            BuiltinFn {
                ...
                self_mutable: false,
                description:
                    "Vibrate the device for given duration (ms). Aliases hardware vibrate.".into(),
            },
            BuiltinFn {
            ...
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Initiate a payment. Routes through configured payment provider."
                    .into(),
            },
            ...
            BuiltinFn {
                ...
                takes_self: false,
                self_mutable: false,
                description: "Get current user info. Routes through configured auth provider."
                    .into(),
            },
            // ── Media ──
            BuiltinFn {
...
mod tests {
    ...
    fn option_unwrap_or_takes_default() {
        let lib = stdlib();
        let unwrap_or = lib
            .lookup_method("Option", "unwrap_or")
    ...
    fn math_functions_are_registered() {
        let lib = stdlib();
        let expected = [
            "abs", "min", "max", "clamp", "pow", "sqrt", "floor", "ceil", "round",
        ];
        for name in &expected {
            assert!(
    ...
    fn rtc_wasm_internal_functions_are_registered() {
        let lib = stdlib();
        let expected = ["rtc_parse_sdp", "rtc_filter_codecs", "rtc_set_bandwidth"];
        for name in &expected {
            assert!(
                lib.lookup_fn(name).is_some(),
    ...
    fn gpu_canvas_functions_are_registered() {
        let lib = stdlib();
        let expected = ["gpu_configure_canvas", "gpu_get_current_texture"];
        for name in &expected {
            assert!(
                lib.lookup_fn(name).is_some(),
    ...
    fn gpu_cleanup_functions_are_registered() {
        let lib = stdlib();
        let expected = ["gpu_destroy_buffer", "gpu_destroy_texture"];
        for name in &expected {
            assert!(
                lib.lookup_fn(name).is_some(),
    ...
    fn gpu_create_render_pipeline_updated_signature() {
        ...
        assert_eq!(
            f.params.len(),
            6,
            "createRenderPipeline should have 6 params (device, shader, vs_entry, fs_entry, topology, format)"
        );
    ...
    fn gpu_begin_render_pass_updated_signature() {
        ...
        assert_eq!(
            f.params.len(),
            7,
            "beginRenderPass should have 7 params (device, view, r, g, b, a, depth)"
        );
    ...
    fn mp_storage_functions_registered() {
        let lib = stdlib();
        assert!(
            lib.lookup_fn("mp_setStorageSync").is_some(),
            "mp_setStorageSync should be registered"
        );
        assert!(
            lib.lookup_fn("mp_getStorageSync").is_some(),
            "mp_getStorageSync should be registered"
        );
        assert!(
            lib.lookup_fn("mp_removeStorageSync").is_some(),
            "mp_removeStorageSync should be registered"
        );
        assert!(
            lib.lookup_fn("mp_clearStorageSync").is_some(),
            "mp_clearStorageSync should be registered"
        );
    }
    ...
    fn mp_navigation_functions_registered() {
        let lib = stdlib();
        assert!(
            lib.lookup_fn("mp_navigateTo").is_some(),
            "mp_navigateTo should be registered"
        );
        assert!(
            lib.lookup_fn("mp_navigateBack").is_some(),
            "mp_navigateBack should be registered"
        );
        assert!(
            lib.lookup_fn("mp_redirectTo").is_some(),
            "mp_redirectTo should be registered"
        );
        assert!(
            lib.lookup_fn("mp_reLaunch").is_some(),
            "mp_reLaunch should be registered"
        );
        assert!(
            lib.lookup_fn("mp_switchTab").is_some(),
            "mp_switchTab should be registered"
        );
    }
    ...
    fn mp_ui_functions_registered() {
        let lib = stdlib();
        assert!(
            lib.lookup_fn("mp_showToast").is_some(),
            "mp_showToast should be registered"
        );
        assert!(
            lib.lookup_fn("mp_hideToast").is_some(),
            "mp_hideToast should be registered"
        );
        assert!(
            lib.lookup_fn("mp_showLoading").is_some(),
            "mp_showLoading should be registered"
        );
        assert!(
            lib.lookup_fn("mp_hideLoading").is_some(),
            "mp_hideLoading should be registered"
        );
        assert!(
            lib.lookup_fn("mp_alert").is_some(),
            "mp_alert should be registered"
        );
        assert!(
            lib.lookup_fn("mp_confirm").is_some(),
            "mp_confirm should be registered"
        );
    }
    ...
    fn mp_device_functions_registered() {
        let lib = stdlib();
        assert!(
            lib.lookup_fn("mp_getSystemInfo").is_some(),
            "mp_getSystemInfo should be registered"
        );
        assert!(
            lib.lookup_fn("mp_getNetworkType").is_some(),
            "mp_getNetworkType should be registered"
        );
        assert!(
            lib.lookup_fn("mp_setClipboard").is_some(),
            "mp_setClipboard should be registered"
        );
        assert!(
            lib.lookup_fn("mp_getClipboard").is_some(),
            "mp_getClipboard should be registered"
        );
        assert!(
            lib.lookup_fn("mp_vibrate").is_some(),
            "mp_vibrate should be registered"
        );
        assert!(
            lib.lookup_fn("mp_getLocation").is_some(),
            "mp_getLocation should be registered"
        );
    }
    ...
    fn mp_network_functions_registered() {
        let lib = stdlib();
        assert!(
            lib.lookup_fn("mp_request").is_some(),
            "mp_request should be registered"
        );
        assert!(
            lib.lookup_fn("mp_uploadFile").is_some(),
            "mp_uploadFile should be registered"
        );
        assert!(
            lib.lookup_fn("mp_downloadFile").is_some(),
            "mp_downloadFile should be registered"
        );
        assert!(
            lib.lookup_fn("mp_connectSocket").is_some(),
            "mp_connectSocket should be registered"
        );
        assert!(
            lib.lookup_fn("mp_sendSocketMessage").is_some(),
            "mp_sendSocketMessage should be registered"
        );
        assert!(
            lib.lookup_fn("mp_closeSocket").is_some(),
            "mp_closeSocket should be registered"
        );
    }
    ...
    fn mp_payment_auth_media_functions_registered() {
        let lib = stdlib();
        assert!(
            lib.lookup_fn("mp_tradePay").is_some(),
            "mp_tradePay should be registered"
        );
        assert!(
            lib.lookup_fn("mp_getAuthCode").is_some(),
            "mp_getAuthCode should be registered"
        );
        assert!(
            lib.lookup_fn("mp_getUserInfo").is_some(),
            "mp_getUserInfo should be registered"
        );
        assert!(
            lib.lookup_fn("mp_chooseImage").is_some(),
            "mp_chooseImage should be registered"
        );
        assert!(
            lib.lookup_fn("mp_previewImage").is_some(),
            "mp_previewImage should be registered"
        );
        assert!(
            lib.lookup_fn("mp_scan").is_some(),
            "mp_scan should be registered"
        );
    }
